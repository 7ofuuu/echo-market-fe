import { Search, ShoppingCart, Bell, MessageCircle, Heart, MapPin, Globe, ShoppingBag, Bot, List, Star, ChevronDown } from 'lucide-react';


export default function ProductCard  ({ product, isDiscounted = false }) {
  return (
    <div className="bg-white rounded-2xl shadow-sm hover:shadow-lg transition-shadow cursor-pointer overflow-hidden">
      ...
      <div className="p-4">
        ...
        <div className="flex items-center mb-2">
          ...
          {!isDiscounted && (
            <span className="text-gray-800 font-bold">Rp {product.price}</span>
          )}
        </div>
