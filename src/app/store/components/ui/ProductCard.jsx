...
export default function ProductCard({ product, isDiscounted = false }) {
  ...
  return (
    <div onClick={handleProductClick} className="bg-white rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 cursor-pointer overflow-hidden transform hover:-translate-y-1">
      <div className="aspect-square bg-gradient-to-br from-blue-200 to-blue-300 flex items-center justify-center relative"></div>
