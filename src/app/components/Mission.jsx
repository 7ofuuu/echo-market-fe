...
export default function MissionComponent() {
  return (
    <section className='grid lg:grid-cols-2 text-white relative overflow-hidden'>
      ...
      <div className='relative h-[620px] bg-cover bg-center group overflow-hidden bg-[url(/echojualan.svg)]'>
        {/* Main content */}
      ...
      <div className='relative h-[620px] bg-cover bg-center group overflow-hidden bg-[url(/echomunitas.svg)]'>
        {/* Main content */}
        <div className='absolute bottom-8 left-8 right-8'>
